...
export function HowItWorksModal() {
  ...
  return (
    <>
      ...
      {open ? (
        <div className="fixed inset-0 z-[80] overflow-y-auto bg-black/75">
          <div className="mx-auto w-full max-w-xl px-4 pb-10 pt-24 sm:pt-28">
            <div className="rounded-2xl border border-cyan-300/35 bg-arena-900 p-6 shadow-[0_22px_70px_rgba(0,0,0,0.55)]">
