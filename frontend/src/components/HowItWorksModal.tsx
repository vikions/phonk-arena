...
export function HowItWorksModal() {
  ...
  return (
    <>
      ...
      {open ? (
        <div className="fixed inset-0 z-50 overflow-y-auto bg-black/70 px-4 py-8 backdrop-blur-sm sm:py-12">
          <div className="mx-auto flex min-h-full w-full max-w-xl items-center">
            <div className="w-full max-h-[calc(100dvh-4rem)] overflow-y-auto rounded-2xl border border-cyan-300/30 bg-arena-900/95 p-6 shadow-neon">
